/* 
	...
	*/
	...
	var
		...
		cleanlog = require('../input/etuscript/logfile_clean.json'),
		scm_user = require('../input/etuscript/users.json')
		;
	...
	doo = function(delay){
		...
		for(var user_i in scm_user){
			if( scm_user.hasOwnProperty(user_i) ){ 
				the_user = scm_user[user_i]['id'];	 
				x=0; y=0; last_time=0;
